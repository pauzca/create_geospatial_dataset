...
if __name__ == '__main__':
    ...
    # segmentation folder
    parser.add_argument('--folder', type=str, default='C:/Users/Usuario/Downloads/Segmentacion/Piedecuesta/output_mask_folder', help='folder containing segmentation masks')
    parser.add_argument('--metadata', type=str, default='C:/Users/Usuario/Downloads/Segmentacion/Piedecuesta/tile_metadata.json', help='path to metadata file')
